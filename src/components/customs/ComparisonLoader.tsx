...
import { CheckCircle2, FileText, ArrowLeftRight, Loader2 } from "lucide-react";
...
const steps = [
  {
    ...
    description: "Preparing documents for comparison...",
    icon: FileText,
    duration: 1500,
  },
  {
  ...
  },
  {
    ...
    description: "Creating comparison summary...",
    icon: CheckCircle2,
    duration: 1500,
  }
];

export function ComparisonLoader({ onComplete }: ComparisonLoaderProps) {
